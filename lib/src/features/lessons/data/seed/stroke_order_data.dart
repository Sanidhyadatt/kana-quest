...
const Map<String, KanaCharacterInfo> kanaCharacterInfo = {
  ...
  'そ': KanaCharacterInfo(strokeCount: 1, soundsLike: 'Sounds like "so" in so!'),
  // ── Hiragana Ta-row ────────────────────────────────────────
  'た': KanaCharacterInfo(
    strokeCount: 4,
    soundsLike: 'Sounds like "ta" in task',
  ),
  'ち': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Sounds like "chi" in cheese',
  ),
  'つ': KanaCharacterInfo(
    strokeCount: 1,
    soundsLike: 'Sounds like "tsu" in tsunami',
  ),
  'て': KanaCharacterInfo(strokeCount: 1, soundsLike: 'Sounds like "te" in ten'),
  'と': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Sounds like "to" in tone',
  ),
  // ── Hiragana Na-row ────────────────────────────────────────
  'な': KanaCharacterInfo(strokeCount: 4, soundsLike: 'Sounds like "na" in nap'),
  'に': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Sounds like "ni" in knee',
  ),
  ...
  'の': KanaCharacterInfo(
    strokeCount: 1,
    soundsLike: 'Sounds like "no" in note',
  ),
  // ── Hiragana Ha-row ────────────────────────────────────────
  ...
  'ふ': KanaCharacterInfo(
    strokeCount: 4,
    soundsLike: 'Sounds like "fu" in food',
  ),
  'へ': KanaCharacterInfo(strokeCount: 1, soundsLike: 'Sounds like "he" in hey'),
  'ほ': KanaCharacterInfo(
    strokeCount: 4,
    soundsLike: 'Sounds like "ho" in hope',
  ),
  // ── Hiragana Ma-row ────────────────────────────────────────
  ...
  'も': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Sounds like "mo" in more',
  ),
  // ── Hiragana Ya-row ────────────────────────────────────────
  'や': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Sounds like "ya" in yard',
  ),
  'ゆ': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Sounds like "yu" in youth',
  ),
  'よ': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Sounds like "yo" in yoga',
  ),
  // ── Hiragana Ra-row ────────────────────────────────────────
  'ら': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Sounds like "ra" in rock',
  ),
  'り': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Sounds like "ri" in reef',
  ),
  'る': KanaCharacterInfo(
    strokeCount: 1,
    soundsLike: 'Sounds like "ru" in root',
  ),
  'れ': KanaCharacterInfo(strokeCount: 2, soundsLike: 'Sounds like "re" in red'),
  'ろ': KanaCharacterInfo(
    strokeCount: 1,
    soundsLike: 'Sounds like "ro" in road',
  ),
  // ── Hiragana Wa-row & N ────────────────────────────────────
  'わ': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Sounds like "wa" in water',
  ),
  ...
  'セ': KanaCharacterInfo(strokeCount: 2, soundsLike: 'Sounds like "se" in set'),
  ...
  '三': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'San — Three',
    reading: 'さん',
  ),
  '四': KanaCharacterInfo(
    strokeCount: 5,
    soundsLike: 'Yon/Shi — Four',
    reading: 'よん',
  ),
  ...
  '七': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Nana/Shichi — Seven',
    reading: 'なな',
  ),
  '八': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Hachi — Eight',
    reading: 'はち',
  ),
  '九': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Kyuu/Ku — Nine',
    reading: 'きゅう',
  ),
  '十': KanaCharacterInfo(
    strokeCount: 2,
  ...
  '日': KanaCharacterInfo(
    strokeCount: 4,
    soundsLike: 'Nichi/Hi — Sun, Day',
    reading: 'にち',
  ),
  '月': KanaCharacterInfo(
    strokeCount: 4,
    soundsLike: 'Getsu/Tsuki — Moon, Month',
    reading: 'つき',
  ),
  '火': KanaCharacterInfo(
    strokeCount: 4,
    soundsLike: 'Ka/Hi — Fire',
    reading: 'ひ',
  ),
  '水': KanaCharacterInfo(
    strokeCount: 5,
    soundsLike: 'Sui/Mizu — Water',
    reading: 'みず',
  ),
  '木': KanaCharacterInfo(
    strokeCount: 4,
    soundsLike: 'Moku/Ki — Tree, Wood',
    reading: 'き',
  ),
  '金': KanaCharacterInfo(
    strokeCount: 8,
    soundsLike: 'Kin/Kane — Gold, Money',
    reading: 'かね',
  ),
  '土': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Do/Tsuchi — Soil, Earth',
    reading: 'つち',
  ),
  '上': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Ue/Jou — Above',
    reading: 'うえ',
  ),
  '下': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Shita/Ka — Below',
    reading: 'した',
  ),
  '左': KanaCharacterInfo(
    strokeCount: 5,
    soundsLike: 'Hidari — Left',
    reading: 'ひだり',
  ),
  '右': KanaCharacterInfo(
    strokeCount: 5,
    soundsLike: 'Migi — Right',
    reading: 'みぎ',
  ),
  '中': KanaCharacterInfo(
    strokeCount: 4,
    soundsLike: 'Naka/Chuu — Middle',
    reading: 'なか',
  ),
  '山': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Yama/San — Mountain',
    reading: 'やま',
  ),
  '川': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Kawa/Sen — River',
    reading: 'かわ',
  ),
  '大': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Oo/Dai — Big, Large',
    reading: 'おおきい',
  ),
  '小': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Ko/Shoo — Small',
    reading: 'ちいさい',
  ),
  '人': KanaCharacterInfo(
    strokeCount: 2,
    soundsLike: 'Hito/Jin — Person',
    reading: 'ひと',
  ),
  '口': KanaCharacterInfo(
    strokeCount: 3,
    soundsLike: 'Kuchi/Kou — Mouth',
    reading: 'くち',
  ),
  '目': KanaCharacterInfo(
    strokeCount: 5,
    soundsLike: 'Me/Moku — Eye',
    reading: 'め',
  ),
  '耳': KanaCharacterInfo(
    strokeCount: 6,
    soundsLike: 'Mimi/Ji — Ear',
    reading: 'みみ',
  ),
  '手': KanaCharacterInfo(
    strokeCount: 4,
    soundsLike: 'Te/Shu — Hand',
    reading: 'て',
  ),
  '足': KanaCharacterInfo(
    strokeCount: 7,
    soundsLike: 'Ashi/Soku — Foot, Leg',
    reading: 'あし',
  ),
  '犬': KanaCharacterInfo(
    strokeCount: 4,
    soundsLike: 'Inu/Ken — Dog',
    reading: 'いぬ',
  ),
  '猫': KanaCharacterInfo(
    strokeCount: 11,
